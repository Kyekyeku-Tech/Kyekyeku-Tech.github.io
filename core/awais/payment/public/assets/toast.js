function message(msg, type) {
    ...
    switch (type || '') {
        case 'success':
            ...
            successBox.style.padding = '30px 17px';
            successBox.style.borderRadius = '8px';
            successBox.style.background = '#000000b5';
        ...
        case 'error':
            ...
            message.style.padding = '30px 6px';
            message.style.border = '1px solid #f9e3e3';
            message.style.borderRadius = '5px';
            message.style.background = '#000000b5';
            message.style.color = '#e47471';
            message.style.textAlign = 'center';
            break;
        default:
            message.style.padding = '30px 17px';
