...
<td width="40%"> <a href="<?php echo e(route('user.login')); ?>" class="btn btn-lg btn-dark w-100 rounded-pill mt-2" style="line-height:35px;">Login</a></td>
    ...
    <div class="modal fade" id="existModalCenter" tabindex="-1" role="dialog" aria-labelledby="existModalCenterTitle"
        aria-hidden="true" style="background-color: #041E42">
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile_auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/core/resources/views/templates/basic/user/auth/register.blade.php ENDPATH**/ ?>