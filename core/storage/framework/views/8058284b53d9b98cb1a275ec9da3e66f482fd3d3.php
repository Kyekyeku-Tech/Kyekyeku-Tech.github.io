            ...
            <div class="card-body p-3">
                <div class="row align-items-center">
                    ...
                    <div class="col text-end">
                        <h5 class="mb-1 small-font-lg text-light">0747167923</h5>
        ...
        <div class="card bg-gr-navy mt-3">
            <div class="card-body p-3">
                <div class="row align-items-center">
                    ...
                    <div class="col text-end">
                        <h5 class="mb-1 small-font-lg text-light">Whatsapp</h5>
                        <a href="<?php echo e(@$inportentLinks->data_values->customer_service_telegram); ?>" class="btn btn-mini btn-light rounded-pill">
                            Join Channel
                        </a>
                    </div>
...
<?php echo $__env->make($activeTemplate.'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oregoazi/public_html/core/resources/views/templates/basic/user/support/online_service.blade.php ENDPATH**/ ?>