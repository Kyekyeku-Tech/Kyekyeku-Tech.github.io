...
<style>
    ...
    <div id="appCapsule" style="background-color:#041E42" >
        <div class="swiper rounded">
            ...
            <div class="swiper-pagination" style="background-color:#041E42"></div>
        </div>
        <div class="container" style="background-color:#041E42">
            <div class="bg-dark-alt rounded-pill p-1 mt-2" style="background-color:#041E42">
        ...
        <div class="container-fluid mt-2 bg-dark-alt" style="background-color:#041E42">
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/core/resources/views/templates/basic/home.blade.php ENDPATH**/ ?>