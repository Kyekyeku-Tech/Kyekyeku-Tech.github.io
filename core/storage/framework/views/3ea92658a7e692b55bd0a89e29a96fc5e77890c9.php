  ...
  <form action="<?php echo e(route('user.withdraw.fund.pass.store')); ?>" method="POST">
        ...
        <div data-v-365a147f="" class="about-us">
            ...
            <div data-v-365a147f="" class="wrap">
                <p data-v-365a147f="" class="left actives" onclick="window.location.href='<?php echo e(route('user.withdraw.fund.pass')); ?>'">Transaction password</p>
                <p data-v-365a147f="" class="right" onclick="window.location.href='<?php echo e(route('user.change.password')); ?>'">Login password</p>
            </div>
                        ...
                        <div data-v-365a147f="" class="van-cell van-cell--large van-field focus-cell">
                            <div class="van-cell__value van-cell__value--alone van-field__value">
                                <div class="van-field__body"><input type="password"
                                                                    name="payment_password" value="<?php echo e($user->fund_pass); ?>"
...
<?php echo $__env->make($activeTemplate . 'layouts.awais', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/tree/core/resources/views/templates/basic/user/withdraw/fund_pass.blade.php ENDPATH**/ ?>