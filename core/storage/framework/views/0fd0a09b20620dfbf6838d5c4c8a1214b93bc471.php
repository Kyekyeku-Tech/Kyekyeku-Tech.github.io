...
<div class="cmn-section" style="background-color: #041E42" >
    <div class="container" style="background-color: #041E42" >
        <div class="row justify-content-center" style="background-color: #041E42" >
            <div class="col-lg-6" style="background-color: #041E42" >
                <form action="<?php echo e(route('user.deposit.insert')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="currency">
                    <div class="card" style="background-color: #041E42" >
                        <div class="card-body" style="background-color: #041E42" >
                            <div class="form-group" style="background-color: #041E42" >
                            ...
                            <div class="mt-3 preview-details d-none" style="background-color: #041E42" >
                                <ul class="list-group" style="background-color: #041E42" >
                                    <li class="list-group-item d-flex justify-content-between" style="background-color: #041E42" >
                                        <span><?php echo app('translator')->get('Limit'); ?></span>
                                        <span><?php echo e(__($general->cur_text)); ?><span class="min fw-bold">0</span>  - <span class="max fw-bold"><?php echo e(__($general->cur_text)); ?></span>0</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span><?php echo app('translator')->get('Charge'); ?></span>
                                        <span><?php echo e(__($general->cur_text)); ?><span class="charge fw-bold">0</span> </span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span><?php echo app('translator')->get('Payable'); ?></span> <span><?php echo e(__($general->cur_text)); ?><span class="payable fw-bold"> 0</span> </span>
                                    </li>
...
<?php echo $__env->make($activeTemplate.'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oregoazi/public_html/core/resources/views/templates/basic/user/payment/deposit.blade.php ENDPATH**/ ?>