                        ...
                        <form action="<?php echo e(route('user.deposit.manual.update')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center text-white">
                                    <p class="text-center mt-2 text-white"><?php echo app('translator')->get('You have requested'); ?> <b  class="text-white"><?php echo e(showAmount($data['amount'])); ?> <?php echo e(__($general->cur_text)); ?></b> , <?php echo app('translator')->get('Please pay'); ?>
...
<?php echo $__env->make($activeTemplate.'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suntechp/ye.suntech.pw/h25/core/resources/views/templates/basic/user/payment/manual.blade.php ENDPATH**/ ?>