        ...
        <div data-v-0aef213b="" class="recharge-record">
            ...
            <div data-v-0aef213b="" class="wrap">
                <div data-v-0aef213b="" class="wrap-top">
                    ...
                    <p data-v-0aef213b=""><?php echo e($general->cur_text); ?>  </p>
                </div>
                    ...
                    <div class="history_box deposit" style="display: block;">
                        <ul>
                            ...
                            <li>
                                <div>
                                    <h3>withdraw</h3>
                                    <p> <?php echo e(showDateTime($withdraw->created_at)); ?>                                          </td>
                                       </td>
</p>
                                </div>
                                <div>
                                    <h3>      <?php echo e(getAmount($withdraw->amount )); ?> <?php echo e(__($general->cur_text)); ?></h3>
                                    <p>
...
<?php echo $__env->make($activeTemplate.'layouts.awais', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/tree/core/resources/views/templates/basic/user/withdraw/log.blade.php ENDPATH**/ ?>