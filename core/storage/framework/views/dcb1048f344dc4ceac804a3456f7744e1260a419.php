...
<div id="appCapsule" style="background-color: #041E42" >
    <div class="container mt-3 mb-3" style="background-color: #041E42" >
        <div class="card glass-bg" style="background-color: #041E42" >
            <div class="card-body" style="background-color: #041E42" >
                <div class="form-group mb-2" style="background-color: #041E42" >
        ...
        <div class="card glass-bg mt-3" style="background-color: #041E42" >
            <div class="card-body" style="background-color: #041E42" >
                <div class="row">
...
<?php echo $__env->make($activeTemplate.'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oregoazi/public_html/core/resources/views/templates/basic/user/referred_team.blade.php ENDPATH**/ ?>