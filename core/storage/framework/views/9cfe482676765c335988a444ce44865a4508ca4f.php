...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset ('core/awais/login/public/Princess/dist/favicon.ico')); ?>">
    <title>cloud miners ~ Login</title>
    <link href="<?php echo e(asset ('core/awais/login/public/Princess/dist/css/app.b95358ff.css')); ?>" rel="preload" as="style">
    <link href="<?php echo e(asset ('core/awais/login/public/Princess/dist/css/chunk-vendors.a206291a.css')); ?>" rel="preload" as="style">
    <link href="<?php echo e(asset ('core/awais/login/public/Princess/dist/css/chunk-vendors.a206291a.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset ('core/awais/login/public/Princess/dist/css/app.b95358ff.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset ('core/awais/login/public/Princess/dist/css/chunk-47a14544.1bde5e14.css')); ?>">
    <style>
        #app .loading-box-h {
            width: 29.333333vw;
            height: 26.333333vw;
...
<?php echo csrf_field(); ?>
        <div id="app">
            ...
            <div data-v-e1c7962c="" class="login">
                <div data-v-e1c7962c="" class="top-bg-wrap"><img data-v-e1c7962c="" src="<?php echo e(asset ('core/awais/login/public/l.jpg')); ?>" alt="" class="bg"></div>
                <div data-v-e1c7962c="" class="wrap-body">
                    ...
                    <div data-v-e1c7962c="" class="login-form form-box">
                        <div data-v-e1c7962c="" class="login-one-box">
                            ...
                            <div data-v-e1c7962c="" class="flex-start to-login"> Don't have an account yet? <a data-v-e1c7962c="" href="<?php echo e(route('user.register')); ?>" class="" style="margin-left: 10px;">To
                                register</a></div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/tree/core/resources/views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>