...
*{
    --mainColor:#2fcc57 !important;
    --secendColor:rgba(0, 0, 0, 0.25)!important;
}
...
<style>
    .card {
        background: radial-gradient(circle at -8.9% 51.2%, var(--mainColor) 24.5%, var(--mainColor) 66%);
    }
    .bg-primary {
...
<style>
    ...
    .bg-dark {
        background: linear-gradient(90deg, #198754 11.2%, #28c76f 78.9%) !important;
    }
    .bg-dark-alt {
        background: linear-gradient(270deg, var(--mainColor) 90.2%, var(--mainColor) 78.9%) !important;
    }

    .btn-primary{
        color:#fff!important ;
        background-color: #2fcc57;
        border-color: #00d094;
    }
    .btn-success{
        color:#fff!important ;
    ...
    body {
        ...
        background: linear-gradient(90deg, #2fcc3b85 11.2%, #2fcc5747 78.9%);
...
<?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/tree/core/resources/views/templates/basic/layouts/custom/mobile_css.blade.php ENDPATH**/ ?>