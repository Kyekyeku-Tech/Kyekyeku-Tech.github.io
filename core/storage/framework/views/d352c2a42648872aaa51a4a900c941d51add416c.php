...
<body>
    ...
    <!-- Bottom Nav -->
    <nav class="navbar fixed-bottom navbar-dark bg-dark-alt" style="background-color:#041E42">
        <div class="container-fluid" style="background-color:#041E42">
            <div class="row mx-auto" style="justify-content: space-evenly" style="background-color:#041E42">
                <div class="col-auto px-3 nav-icon" style="background-color:#041E42">
...
<?php /**PATH /home/sites/2a/9/9175d3ede1/public_html/cloudminers.site/core/resources/views/templates/basic/layouts/mobile.blade.php ENDPATH**/ ?>