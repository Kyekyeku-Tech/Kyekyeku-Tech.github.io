                ...
                <div class="card-body" style="background-color: #041E42" >
                    <div class="row">
                        <div class="col-5">
                            ...
                            <h5 class="mb-0 text-primary small-font-lg userBalanceRound"><?php echo e($general->cur_text); ?> <?php echo e(getAmount($user->balance)); ?> </h5></center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <p class="mb-0 text-start small-font text-primary">
                                    <?php echo e($general->cur_text); ?> <?php echo e($item->plan->daily_profit); ?> 
                                </p>
                            </div>
                        </div>
                        <div class="row">
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oregoazi/public_html/core/resources/views/templates/basic/user/runing_plans.blade.php ENDPATH**/ ?>