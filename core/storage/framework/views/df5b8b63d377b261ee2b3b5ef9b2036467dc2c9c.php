        ...
        <?php if(!$user->bank_card): ?>
            <div class="container mt-3 mb-3" style="background-color: #041E42" >
                <form action="<?php echo e(route('user.bank.card.store')); ?>" method="POST">
                    ...
                    <div class="mb-3" style="background-color: #041E42" >
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oregoazi/public_html/core/resources/views/templates/basic/user/bank_card.blade.php ENDPATH**/ ?>