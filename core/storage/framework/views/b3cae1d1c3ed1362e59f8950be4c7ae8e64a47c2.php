        ...
        <div class="container mt-3 mb-3">
            ...
            <div class="card glass-bg my-3">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-walle text-primary" style="font-size: 40px; opacity: 100%;"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card rounded glass-bg mt-5">
                <div class="card-header border-secondary py-1">
                    <p class="text-white">Warm Tips</p>
                </div>
                <div class="card-body">
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/oregoazi/public_html/core/resources/views/templates/basic/user/withdraw/new/withdraw.blade.php ENDPATH**/ ?>