...
<head>
    ...
    <link rel="icon" href="{{asset ('core/awais/register/public/Princess/dist/favicon.ico')}}">
    <title>cloud miners ~Register</title>
    <link href="{{asset ('core/awais/register/public/Princess/dist/css/chunk-vendors.a206291a.css')}}" rel="stylesheet">
    <link href="{{asset ('core/awais/register/public/Princess/dist/css/app.b95358ff.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/register/public/Princess/dist/css/chunk-47a14544.1bde5e14.css')}}">
    <style>
        #app .loading-box-h {
            width: 29.333333vw;
            height: 26.333333vw;
            ...
            <div data-v-652d2876="" class="login">
                <div data-v-652d2876="" class="title van-nav-bar van-hairline--bottom">
                    <div class="van-nav-bar__content">
                        <div class="van-nav-bar__left" onclick="window.location.href='{{route ('user.login')}}'"><i class="van-icon van-icon-arrow-left van-nav-bar__arrow"></i></div>
                    ...
                    <div data-v-652d2876="" class="login-one-box">
                        ...
                        <div data-v-652d2876="" class="register-cell van-cell-group van-hairline--top-bottom">
                            <div data-v-652d2876="" class="van-cell van-cell--large van-field van-field--disabled">
                                <div class="van-cell__value van-cell__value--alone van-field__value">
                                    <div class="van-field__body"><input type="text" name="referBy" value="{{ session()->get('inviteCode') }}" placeholder="Please enter the invitation code" class="van-field__control" readonly></div>
                                </div>
                            </div>
                        </div>
