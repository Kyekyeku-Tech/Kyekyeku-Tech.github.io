...
<head>
    ...
    <link rel="icon" href="{{asset ('core/awais/withdraw/public/Princess/dist/favicon.ico')}}">
    <title>Cloud Miners Withdraw</title>
    <link href="{{asset ('core/awais/withdraw/public/Princess/dist/css/chunk-47a14544.1bde5e14.css')}}" rel="prefetch">
    <link href="{{asset ('core/awais/withdraw/public/Princess/dist/css/chunk-vendors.a206291a.css')}}" rel="stylesheet">
    <link href="{{asset ('core/awais/withdraw/public/Princess/dist/css/app.b95358ff.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/withdraw/public/Princess/dist/css/chunk-a17cb2fa.966c6e7b.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/withdraw/public/Princess/dist/css/chunk-7a7e003a.ae7e86d6.css')}}">
    <style>
        .withdraws .account-balance[data-v-4c54b7c3] {
            background: url({{asset ('core/awais/withdraw/public/Princess/withdraw.f60d20d0.png')}}) no-repeat 50%/100% auto;
        }

        .withdraws[data-v-4c54b7c3]:after {
            background: url({{asset ('core/awais/withdraw/public/Princess/recharge-bg.0ab0e98a.png')}}) no-repeat 50%/100%;
        }
          ...
          <form action="{{route('user.withdraw.new.now')}}" method="POST" class="mb-2">
            ...
            <div data-v-4c54b7c3="" class="withdraws after">
                ...
                <div data-v-4c54b7c3="" class="account-balance">
                    ...
                    <p data-v-4c54b7c3="">  {{ $general->cur_sym }} {{ showAmount($user->balance) }}</p>
                    <p data-v-4c54b7c3="" onclick="window.location.href='{{route('user.withdraw.history')}}'"> Withdrawals record <i data-v-4c54b7c3="" class="van-icon van-icon-arrow"></i>
                    </p>
                </div>
                ...
                <div data-v-4c54b7c3="" class="apply-amount">
                    ...
                    <div data-v-4c54b7c3="" class="transaction flex">
                        ...
                        <p data-v-4c54b7c3="" class="notset"><span data-v-4c54b7c3="" onclick="window.location.href='{{route('user.change.password')}}'">click settings</span><i data-v-4c54b7c3="" class="van-icon van-icon-arrow">
                        </i></p>
                    </div>
                    <div data-v-4c54b7c3="" class="amount-input">
                        <div data-v-4c54b7c3="" class="block-cell van-cell-group van-hairline--top-bottom">
                    ...
                    <div data-v-4c54b7c3="" class="rules-text">
                        <p data-v-4c54b7c3="">1. Fill in the correct wallet account when withdrawing money. If you enter the wrong account, your withdrawal will fail and you can withdraw again.
                            <br><br> 2. The platform withdrawal time is from 8:00 to 16:00, updated at 00:00 every day, and withdrawals are made once a day.<br><br> 3. Minimum withdrawal amount   {{ $general->cur_sym }} .200, withdrawal fee 0% (used for equipment maintenance)
