...
<head>
    ...
    <link href="{{asset ('core/awais/bank/public/Princess/dist/css/app.b95358ff.css')}}" rel="preload" as="style">
    <link href="{{asset ('core/awais/bank/public/Princess/dist/css/chunk-vendors.a206291a.css')}}" rel="preload" as="style">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/bank/public/Princess/dist/css/chunk-47a14544.1bde5e14.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/bank/public/Princess/dist/css/chunk-257feb4d.2bcb8493.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/bank/public/Princess/dist/css/chunk-6d0afc0e.099504fe.css')}}">

    <style>
        .bind-card .header[data-v-9ebdd7a8] {
            background: url({{asset ('core/awais/bank/public/Princess/SS.0baa227f.png')}}) no-repeat 50%/100% auto;
        }
        *{
            user-select: none;
        }
            ...
            <div data-v-9ebdd7a8="" class="header">
                <div data-v-9ebdd7a8="" class="van-nav-bar van-hairline--bottom">
                    <div class="van-nav-bar__content">
                        <div class="van-nav-bar__left" onclick="window.location.href='{{route ('user.home')}}'"><i
...
<div class="van-toast van-toast--middle loadingcss" style="z-index: 2012; display: none;"><i
        class="van-icon van-toast__icon"><img src="{{asset ('core/awais/bank/public/Princess/dist/img/loading.e2df1b5d.gif')}}"
                                              class="van-icon__image">
    </i></div>
<script src="{{asset ('core/awais/bank/public/assets/toast.js')}}"></script>
<script>
