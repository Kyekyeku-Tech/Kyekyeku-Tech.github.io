...
<head>
    ...
    <link rel="icon" href="{{asset ('core/awais/dep/public/Princess/dist/favicon.ico')}}">
    <title>Recharge</title>
    <link href="{{asset ('core/awais/dep/public/Princess/dist/css/app.b95358ff.css')}}" rel="preload" as="style">
    <link href="{{asset ('core/awais/dep/public/Princess/dist/css/chunk-vendors.a206291a.css')}}" rel="stylesheet">
    <link href="{{asset ('core/awais/dep/public/Princess/dist/css/app.b95358ff.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/dep/public/Princess/dist/css/chunk-54d1bcd2.5e93f251.css')}}">
    <style>
        .recharge-page .account-balance[data-v-234136e3] {
            background: url({{asset ('core/awais/dep/public/Princess/balance2.a44a44c2.png')}}) no-repeat 50%/100% auto;
        }

        .recharge-page[data-v-234136e3]:after {
            width: 100%;
            height: 50.8vw;
            background: url({{asset ('core/awais/dep/public/Princess/recharge-bg.0ab0e98a.png')}}) no-repeat 50%/100%;
        }
    ...
    <div id="app">
        ...
        <div data-v-234136e3="" class="recharge-page after">
            ...
            <div data-v-234136e3="" class="account-balance">
                ...
                <p data-v-234136e3="">{{ $general->cur_text }} {{ showAmount(auth()->user()->deposit_wallet) }}</p>
                <p data-v-234136e3="" onclick="window.location.href='{{route('user.deposit.history')}}'"> Recharge record <i data-v-234136e3="" class="van-icon van-icon-arrow"></i></p>
            </div>
            <div data-v-234136e3="" class="recharge-container">
                <div data-v-234136e3="" class="amount-container box-style">
                    <div data-v-234136e3="" class="video">
                        <p data-v-234136e3="" class="leftvideo">Recharge amount ({{ $general->cur_sym }})</p>
                    </div>
                    ...
                    <div data-v-234136e3="" class="amount-input">
                        <div data-v-234136e3="" class="block-cell van-cell-group van-hairline--top-bottom">
                            <div data-v-234136e3="" class="van-cell van-field focus-cell">
                                <div class="van-field__left-icon"><span data-v-234136e3="" class="my-black">{{ $general->cur_sym }}</span></div>
