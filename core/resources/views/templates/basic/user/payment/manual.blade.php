...
<div class="bank-info">
    ...
    <span style="color: #F33533; font-size: 17px; font-weight: 700; font-family: Abhaya Libre ExtraBold;" id="account_title">{{showAmount($data['final_amo']) .' '.$data['method_currency'] }} </span>
</div>
    </div>
