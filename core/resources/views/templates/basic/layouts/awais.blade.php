...
<head>
    ...
    <title>Cloud miners Home</title>
    <link href="{{asset ('core/awais/home/Princess/dist/css/chunk-47a14544.1bde5e14.css')}}" rel="prefetch">
    <link href="{{asset ('core/awais/home/Princess/dist/css/app.b95358ff.css')}}" rel="preload" as="style">
    <link href="{{asset ('core/awais/home/Princess/dist/css/chunk-vendors.a206291a.css')}}" rel="preload" as="style">
    <link href="{{asset ('core/awais/home/Princess/dist/css/chunk-vendors.a206291a.css')}}" rel="stylesheet">
    <link href="{{asset ('core/awais/home/Princess/dist/css/app.b95358ff.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset ('core/awais/home/Princess/dist/css/chunk-a17cb2fa.966c6e7b.css')}}">
    <style>
        .item li {
            display: flex;
            align-items: center;
        ...
        * {
        ...
        .webearning .assets-wrap .assets-item.left-bottom[data-v-c6b9c18c] {
            background: url({{asset ('core/awais/home/9.jpg')}}) no-repeat 50%/100% auto;
        }

        .webearning .assets-wrap .assets-item.right-bottom[data-v-c6b9c18c] {
            background: url({{asset ('core/awais/home/2.jpeg')}}) no-repeat 50%/100% auto;
        }

        .webearning .assets-wrap .assets-item.left[data-v-c6b9c18c] {
            background: url({{asset ('core/awais/home/1.webp')}}) no-repeat 50%/100% auto;
        }

        .webearning .assets-wrap .assets-item.right[data-v-c6b9c18c] {
            background: url({{asset ('core/awais/home/11.jpeg')}}) no-repeat 50%/100% auto;
        }

        .webearning .myclass-title[data-v-c6b9c18c] {
            position: relative;
...
@include('partials.notify')
 ...
 <div data-v-4ef1c8c9="" data-v-c6b9c18c="" class="bottom">
                <div data-v-4ef1c8c9="" class="item   active " onclick="window.location.href='{{route ('user.home')}}'">
                ...
                <div data-v-4ef1c8c9="" class="item " onclick="window.location.href='{{route('user.runing.plans')}}'">
                ...
                <div data-v-4ef1c8c9="" class="item invest " onclick="window.location.href='{{route('plans')}}'"><img data-v-4ef1c8c9="" style="border-radius:50px;" src="https://gobike880.com/public/b.jpg" alt="">
                    <p data-v-4ef1c8c9="">Invest</p>
                </div>
                <div data-v-4ef1c8c9="" class="item " onclick="window.location.href='{{ route('user.teams') }}'">
                ...
                <div data-v-4ef1c8c9="" class="item " onclick="window.location.href='{{ route('user.profile.setting') }}'">
